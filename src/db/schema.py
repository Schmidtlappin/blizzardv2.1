"""
Database schema module for Blizzard.
"""
...
def get_schema_path() -> str:
    ...
    return os.path.join(schema_dir, 'irs990_dynamic_schema.sql')


def create_default_schema() -> None:
    """Create the default database schema file if it doesn't exist."""
    ...
    # Create the default schema file
